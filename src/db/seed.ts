...
const SEED_MOVEMENTS: SeedMovement[] = [
...

  {
    ...
    description:
      "Wrist warmup: circles, prayer stretch forward & back, compression on floor. Never skip before push work.",
  },
  {
    name: "L-Sit Hang on Parallettes",
    description:
      "L-sit on parallettes with feet flat on floor. Push bars down hard, shoulders away from ears, straight arms.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Seated with legs straight in front. Pulse chest toward thighs, back stays straight. Go to end range.",
  },
  {
    name: "Arch Body Hold",
    description:
      "Face down, lift arms and legs off floor. Hold tension. Posterior chain — replaces Superman.",
  },
  {
    name: "Chin-Up Hold",
    description:
      "Isometric chin-up hold at 90° elbow bend. Hold as long as possible (~15–20 sec).",
  },
  {
    name: "Hip Flexor Stretch",
    description:
      "Kneeling lunge. Keep torso upright. Gentle hold, no bouncing.",
  },
  {
    name: "Seated Forward Fold",
    description:
      "Straight legs, hinge at hip with straight back. Chest toward thighs.",
  },
  {
    name: "Band Pull-Aparts",
    description:
      "Hold band at shoulder width, pull apart out to sides. Shoulder health — keep light.",
  },
  {
