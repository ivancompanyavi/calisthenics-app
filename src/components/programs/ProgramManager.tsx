...
// Program list + create/edit/delete/activate. Headerless so it can live both
// under the Library "Programs" sub-tab and the standalone /programs route.
  ...
  return (
    <div className="space-y-3">
      ...
      {programs?.map((program) => (
        <Card
          key={program.id}
          className={`p-4 ${isActive(program.id) ? 'ring-2 ring-primary' : ''}`}
        >
