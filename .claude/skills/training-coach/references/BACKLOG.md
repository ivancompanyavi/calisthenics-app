# KB Backlog — books to distill next

Same pipeline as OG2/Tendonitis (extract → gitignored `_sources/` → Sonnet fan-out distill → INDEX entry).
Only distill a book once its PDF is legally owned and in `docs/reference/`.
...
- **Brad Schoenfeld — Science and Development of Muscle Hypertrophy (2e)** — the hypertrophy
  textbook; `[SCIENCE]` citation source for volume/intensity/frequency.
- **RP — Scientific Principles of Hypertrophy Training** — optional; overlaps Helms.
- **Kit Laughlin — Stretching & Flexibility** — mobility gap (pike/shoulder).

**Skip (redundant / lower rigor):** Convict Conditioning, The Naked Warrior, Complete Calisthenics, Hybrid Calisthenics.

## Token budget note
Cost scales with page count × chapters. OG2 (598pp/21ch) ≈ 1.29M; Tendonitis (152pp/8ch) ≈ 462K.
Estimate a Pyramid volume at roughly OG2/2. Run one book (or one Pyramid volume) at a time.
